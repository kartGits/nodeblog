...
// Add this route to serve the Edit Post form
router.get('/edit-post/:id', authMiddleware, async (req, res) => {
    try {
        const locals = {
            title: 'Edit Post',
            description: 'Edit the content of your blog post.',
        };
...
router.get('/logout', (req, res) => {
    ...
    // res.json({meassage: 'Logout successful.'});
    res.redirect('/');
});
